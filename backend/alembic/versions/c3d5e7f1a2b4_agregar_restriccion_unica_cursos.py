"""Agregar restriccion unica a cursos
...
def upgrade() -> None:
    ...
    # Eliminar filas duplicadas (mantener la de menor id) antes de crear la restriccion
    op.execute(
        """
        WITH duplicates AS (
    ...
    # Agregar restriccion unica para nombre + anio_lectivo
