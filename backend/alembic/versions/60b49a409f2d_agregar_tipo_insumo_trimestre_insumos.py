"""Agregar tipo de insumo y trimestre a insumos
...
def upgrade() -> None:
    ...
    # Crear la restriccion unica para proyectos y examenes por trimestre
    # Esta restriccion asegura que solo haya un proyecto_trimestral o examen_trimestral
